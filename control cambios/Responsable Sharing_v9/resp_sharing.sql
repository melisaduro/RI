...
from agrids_v2.dbo.lcc_ciudades_tipo_project_v9 t1, #iterator t2
where t1.ine=t2.ine
...
--select t1.*, t2.tipo as Responsable_Sharing
...
select * from agrids_v2.dbo.lcc_ciudades_tipo_project_v9_WILLIAMS
